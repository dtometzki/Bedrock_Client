...
function buildModelSelectionLines(models, currentModelId, selectedIndex, promptLabel) {
  ...
  lines.push(`${ANSI.gray}Pfeiltasten zum Wählen, Enter zum Bestätigen, Esc zum Abbrechen.${ANSI.reset}`);
  return lines;
}
...
export async function promptForModelSelection(rl, models, currentModelId, promptLabel = "Wähle ein Modell") {
